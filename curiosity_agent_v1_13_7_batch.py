...
RUN_DATA_CSV        = "run_data_v1_13_7.csv"
PROVENANCE_CSV      = "provenance_v1_13_7.csv"
GOAL_CSV            = "goal_v1_13_7.csv"
COUNTERFACTUAL_CSV  = "counterfactual_v1_13_7.csv"
BELIEF_REVISION_CSV = "belief_revision_v1_13_7.csv"
CAUSAL_CSV          = "causal_v1_13_7.csv"
REPORT_CSV          = "report_v1_13_7.csv"
REPORT_SUMMARY_CSV  = "report_summary_v1_13_7.csv"
END_STATE_DRAW_CSV  = "end_state_draw_log_v1_13_7.csv"
ENV2_RUN_DATA_CSV   = "env2_run_data_v1_13_7.csv"
Q5_INDIVIDUATION_CSV = "q5_individuation_v1_13_7.csv"
PREDICTED_SCHEMA_CSV = "predicted_schema_v1_13_7.csv"
...
def _check_transfer_condition(world, agent, schema_v13_obs):
    """Return True if ENV1 transfer condition is satisfied.

    v1.13.4 transfer condition (Montessori room-completion gate restored):
      1. end_state_banked — agent has completed all completable ENV1 work.
         With haz_blue declared unreachable, the end_state can now fire once
         YELLOW + GREEN + unaffiliated hazards + free attractors are done.
         This is the v1.12-equivalent 'finish the room' gate.
      2. haz_blue approached — verified in the outer guard before this call.
      3. Predicted schema record written for haz_blue — the inference exists.

    The predicted record is the transfer credential that distinguishes v1.13
    from v1.12: the agent does not just complete the room, it carries forward
    a specific open question about what it found there.
    """
    if not getattr(agent, 'end_state_banked', False):
        return False
    if not any(r["object_id"] == "haz_blue"
...
def _run_environment(
    ...
    for step in range(num_steps):
        ...
        if (env_number == 1 and not transfer_condition_met
                and haz_blue_approached):
            if with_prediction and schema_v13_obs is not None:
                if _check_transfer_condition(world, agent, schema_v13_obs):
